  ...
  async function generateAnswer(e) {
    ...
    try {
      const response = await axios({
        ...
        data: {
          contents: [
            { parts: [{ text: `${medicalAssistantPrompt}\n\nQuestion: ${currentQuestion}` }] }
          ],
        },
      });
    ...
    <div className="fixed inset-0 bg-gray-900 text-white">
      <div className="h-full mx-auto flex flex-col px-16">
        <header className="mb-8 py-4">
          <a
            href="https://github.com/raghavjaiswal709/MediMitra"
            target="_blank"
        ...
        >
            ...
            <div className="h-full flex flex-col items-center justify-center text-center p-6">
              <div className="bg-gray-700 rounded-xl p-8 max-w-2xl">
                ...
                <p className="text-gray-300 mb-4">
                  I'm here to assist you with medical queries, health tips, and general wellness advice. You can ask
                  me about:
                </p>
          ...
          {generatingAnswer && (
            <div className="text-left">
              <div className="inline-block bg-gray-700 p-3 rounded-lg animate-pulse">Analyzing...</div>
            </div>
          )}
        </div>
